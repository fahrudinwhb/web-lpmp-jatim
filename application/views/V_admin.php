...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <?php $this->load->view("V_admin_left-side") ?>
      <!--end left side-->
            ...
            <section class="col-lg-7 connectedSortable">
              ...
              <div class="box box-success">
                ...
                <div class="box-body chat" id="chat-box">
                  <!-- chat item -->
                  <div class="item">
                    <img src="<?php echo base_url('/assets/img/admin/'.$this->session->userdata['admin'][0]['foto']); ?>" alt="user image" class="online">
                    <p class="message">
                      <a href="#" class="name">
                  ...
                  <!-- chat item -->
                  <div class="item">
                    <img src="<?php echo base_url('/assets/img/admin/'.$this->session->userdata['admin'][0]['foto']); ?>" alt="user image" class="offline">
                    <p class="message">
                      <a href="#" class="name">
                        <small class="text-muted pull-right"><i class="fa fa-clock-o"></i> 5:15</small>
                        <?php echo $this->session->userdata['admin'][0]['username'];?>
                      </a>
                      I would like to meet you to discuss the latest news about
                      the arrival of the new theme. They say it is going to be one the
                      best themes on the market
